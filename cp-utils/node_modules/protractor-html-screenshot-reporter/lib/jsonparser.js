var run_all = require("../../../../run_all.js");
...
phssr.makeHTMLPage = function(tableHtml, reporterOptions){
    ...
    staticHTMLContentprefix +=  "<h1>Automation Test Results</h1><table class='header'>";
    ...
    //staticHTMLContentprefix +=  "<class='img-col'><b>Build Version</b> = 1.1</tr><br></table>";
    //staticHTMLContentprefix +=  "<class='img-col'><b>IP Address</b> = 192.168.1.1</tr><br></table>";
    //staticHTMLContentprefix +=  "<class='img-col'><b>Suite Name</b> = Regression</tr><br></table>";
    //staticHTMLContentprefix +=  "<class='img-col'><b>Execution start time</b> ="+new Date()+"</br></tr></table>";
...
function processJson(jsonData, options){
    ...
    timeStampEnd = runEndTime.getMonth() + 1 + '-' + runEndTime.getDate() + '-' + runEndTime.getFullYear() + '-' + runEndTime.getHours() + 'h-' + runEndTime.getMinutes() + 'm';

    tableHtml = '<ul>' + tableHtml + '</ul>';
    tableHtml += "<div><h2><u>Results summary</u></h2>";
    var testCount = passCount + failCount;
    tableHtml += "<b>Total tests execute</b>: "+ testCount +"<br/><b>Total tests passed</b>: "+ passCount +" <br/> <b>Total tests failed</b>: "+ failCount +" <br/> </div>";
    tableHtml += "<b>Success Rate</b>:"+(passCount/testCount)*100+"%</div>";

    tableHtml += "<br><b>Build Version: </b> 1.1 </div>";
    tableHtml += "<br><b>IP Address: </b>" +ip.address()+ "</div>";
    tableHtml += "<br><b>Environment: </b>" +env.cps_url+ "</div>";
    tableHtml += "<br><b>Execution start time: </b>" + timeStampEnd + "</div>";
