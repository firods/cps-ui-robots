...
describe("dpc-130568:Accounts:P1-Verify-reset-admin-password-noadmin-functionality", function() {
    ...
    it("dpc-130568", function() {

        // login to cps cloud portal.
        loginUtils.cpsLogin(envConfig_Json.salesOps_uname,envConfig_Json.salesOps_pass);

        // reset admin password with no admin.
        customeraccountsUtils.verifyResetadminpassword_noadmin();
    });
