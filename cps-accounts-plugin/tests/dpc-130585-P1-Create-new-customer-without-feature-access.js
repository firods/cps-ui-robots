...
describe("dpc-130585:Accounts:P1-Create-new-customer-without-feature-access", function() {
    ...
    it("dpc-130585", function() {

        // login to cps cloud portal.
        loginUtils.cpsLogin(envConfig_Json.salesOps_uname,envConfig_Json.salesOps_pass);

        // create customer without feature access.a
        customeraccountsUtils.createNewCustomerwithoutFeatureaccess();
    });
