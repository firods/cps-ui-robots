...
describe("dpc-130567:Accounts:P3-Reset admin password multiple users.", function() {
    ...
    it("dpc-130567", function() {
        ...
        customeraccountsUtils.resetadminpassword_multipleusers();
    });
