...
describe("dpc-130547:Accounts:P1:Create new customer with feature access", function() {
    ...
    it("dpc-130547", function() {
        ...
        customeraccountsUtils.createNewCustomerwithFeatureaccess();
    });
