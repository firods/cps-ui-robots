describe("dpc-130558:EHN:P1:Notification Settings->Remove&RemoveAll recepients", function() {
    ...
    it("dpc-130558", function() {
        ...
        events_historyUtils.verifyRemoveRecipientFunctionality(login_creds.salesOps_uname);
