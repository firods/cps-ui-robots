describe("dpc-130604:Dashboard:P1:Verify clicking on Cloud Portal logo navigates to dashboard", function() {
    ...
    it("dpc-130604", function() {
        ...
        dashboardUtils.verifyCloudPortalLogoNavigatesToDashboard();
    });
});
