describe("dpc-130372:Pagination:P2: prev button should be disable when user is on the first page", function() {
    ...
    it("dpc-130372", function() {
        ...
        paginationUtils.verifySelectedPageHighlight();
    });
