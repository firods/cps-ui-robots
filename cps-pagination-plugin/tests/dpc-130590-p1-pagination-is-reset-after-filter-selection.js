 ...
 */
describe("dpc-130590:Pagination:P1:Pagination is reset after filter selection", function() {
    ...
    it("dpc-130590", function() {

        //Login to Cloud Portal
        loginUtils.cpsLogin(envConfig_Json.salesOps_uname,envConfig_Json.salesOps_pass);

        //Verify if navigation to any page list the records from that page for EHN plugin
        paginationUtils.resetPaginationEHN();
