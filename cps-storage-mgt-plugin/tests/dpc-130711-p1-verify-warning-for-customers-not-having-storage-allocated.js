...
describe("dpc-130711:StorageManagement:P1:Verify warning for customer not having storage allocated", function() {
    ...
    it("dpc-130711", function() {
        //Login to Cloud Portal
        loginUtils.cpsLogin(login_creds.tenant_without_storage_uname,login_creds.tenant_without_storage_pass);

        //Verify Refresh functionality
        storageMgtUtils.verifyWarningForCustomersNotHavingStorageAllocated();
    });
});